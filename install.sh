...
INSTALL_DIR="/opt/HS110EnergyCollector/"

echo "=== Installing HS110EnergyCollector application ==="
...
echo "=== Installing HS110EnergyCollector systemd service ==="

echo "Copying over service ..."

cp -f systemd/* /etc/systemd/system/

echo "Setting correct path in system ..."

sed -i "s|{WORKDIR}|${INSTALL_DIR}|g" /etc/systemd/system/hs110-energy-collector.service

echo "Enabling service ..."

systemctl enable hs110-energy-collector.service
systemctl start hs110-energy-collector.service
